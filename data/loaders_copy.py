...
class SteelDataset(Dataset):
    """ This version tries to load the whole thing into memory, thereby reducing
        the influence of network lag.
    """
    def __init__(self, train = True):
        if train:
        ...
        self.chunksize = len(self.catalog)
        self.threads = 32
        self.load_starting_from(0)
        print("loaded data")
